...
DECLARE_ATTRIBUTE(MathML, Style, fontsize);
...
DECLARE_ATTRIBUTE(MathML, Token, fontsize);
DECLARE_ATTRIBUTE(MathML, Token, fontweight);
DECLARE_ATTRIBUTE(MathML, Token, fontstyle);
DECLARE_ATTRIBUTE(MathML, Token, fontfamily);
DECLARE_ATTRIBUTE(MathML, Token, color);
