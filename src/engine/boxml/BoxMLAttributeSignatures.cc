...
DEFINE_ATTRIBUTE(BoxML, HV, "indent", indent, true, false, false, false, "0pt");
DEFINE_ATTRIBUTE(BoxML, HV, "minlinespacing", minlinespacing, true, false, false, false, "1.8em");
DEFINE_ATTRIBUTE(BoxML, HOV, "spacing", spacing, true, false, false, false, "0pt");
DEFINE_ATTRIBUTE(BoxML, HOV, "indent", indent, true, false, false, false, "0pt");
DEFINE_ATTRIBUTE(BoxML, HOV, "minlinespacing", minlinespacing, true, false, false, false, "1.8em");
DEFINE_ATTRIBUTE(BoxML, V, "enter", enter, true, false, false, false, "1");
DEFINE_ATTRIBUTE(BoxML, V, "exit", exit, true, false, false, false, "-1");
DEFINE_ATTRIBUTE(BoxML, V, "indent", indent, true, false, false, false, "0pt");
DEFINE_ATTRIBUTE(BoxML, V, "minlinespacing", minlinespacing, true, false, false, false, "1.8em");
