...
class BoxMLTextElement : public MathMLElement
{
protected:
  BoxMLTextElement(const SmartPtr<class View>&);
  virtual ~BoxMLTextElement();

public:
  static SmartPtr<BoxMLTextElement> create(const SmartPtr<class View>&);
