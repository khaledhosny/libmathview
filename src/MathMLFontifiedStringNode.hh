...
#ifndef MathMLFontifiedStringNode_hh
#define MathMLFontifiedStringNode_hh

#include <config.h>

#include "MathMLFontifiedNode.hh"

class MathMLFontifiedStringNode: public MathMLFontifiedNode {
public:
...
#endif // MathMLFontifiedStringNode_hh
