...
OpenTypeMathGraphicDevice::OpenTypeMathGraphicDevice(const SmartPtr<AbstractLogger>& logger,
                                                     const SmartPtr<MathFont>& font)
  : MathGraphicDevice(logger)
  , mathFont(font)
{ }

OpenTypeMathGraphicDevice::~OpenTypeMathGraphicDevice()
{ }

scaled
OpenTypeMathGraphicDevice::getConstant(const FormattingContext& context,
...
scaled
OpenTypeMathGraphicDevice::getRuleThickness(const FormattingContext& context,
                                            MathConstant constant) const
{
  // at least 1px thick
...
scaled
OpenTypeMathGraphicDevice::ex(const FormattingContext& context) const
{
  // XXX
...
scaled
OpenTypeMathGraphicDevice::axis(const FormattingContext& context) const
{
  return getConstant(context, axisHeight);
}

scaled
OpenTypeMathGraphicDevice::defaultLineThickness(const FormattingContext& context) const
{
  // XXX
...
AreaRef
OpenTypeMathGraphicDevice::wrapper(const FormattingContext&, const AreaRef& area) const
{
  return getFactory()->box(area, area->box());
}

AreaRef
OpenTypeMathGraphicDevice::dummy(const FormattingContext& context) const
{
...
void
OpenTypeMathGraphicDevice::clearCache() const
{
...
AreaRef
OpenTypeMathGraphicDevice::stretchedString(const FormattingContext& context, const String& str) const
{
...
AreaRef
OpenTypeMathGraphicDevice::unstretchedString(const FormattingContext& context, const String& str) const
{
...
AreaRef
OpenTypeMathGraphicDevice::string(const FormattingContext& context,
...
AreaRef
OpenTypeMathGraphicDevice::stretchStringV(const FormattingContext& context,
                                          const String& str,
                                          const scaled& height,
...
AreaRef
OpenTypeMathGraphicDevice::glyph(const FormattingContext& /*context*/,
                                 const String& /*alt*/,
...
AreaRef
OpenTypeMathGraphicDevice::fraction(const FormattingContext& context,
...
AreaRef
OpenTypeMathGraphicDevice::bevelledFraction(const FormattingContext& context,
                                            const AreaRef& numerator,
                                            const AreaRef& denominator,
                                            const Length& lineThickness) const
{
...
AreaRef
OpenTypeMathGraphicDevice::radical(const FormattingContext& context,
                                   const AreaRef& base,
...
void
OpenTypeMathGraphicDevice::calculateDefaultScriptShift(const FormattingContext& context,
...
void
OpenTypeMathGraphicDevice::calculateScriptShift(const FormattingContext& context,
                                                const BoundingBox& baseBox,
                                                const BoundingBox& subScriptBox,
...
AreaRef
OpenTypeMathGraphicDevice::script(const FormattingContext& context,
                                  const AreaRef& base,
...
AreaRef
OpenTypeMathGraphicDevice::multiScripts(const FormattingContext& context,
                                        const AreaRef& base,
...
AreaRef
OpenTypeMathGraphicDevice::underOver(const FormattingContext& context,
                                     const AreaRef& base,
...
AreaRef
OpenTypeMathGraphicDevice::enclose(const FormattingContext& context,
                                   const AreaRef& base,
