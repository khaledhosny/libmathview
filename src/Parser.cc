...
MathMLParser::MathMLParser(const char* s)
{
  fileName = s;
  doc = NULL;
}
...
MathMLParser::Parse()
{
  doc = MathMLParseFile(fileName, false);
...
void
MathMLParser::MathMLizeNode(mDOMNodeRef node, MathMLContainerElement* parent)
{
  assert(node != NULL);
  assert(parent != NULL);
...
void
MathMLParser::MathMLizeContainerContent(mDOMNodeRef node, MathMLContainerElement* parent)
{
  assert(node != NULL);
  assert(parent != NULL);
...
void
MathMLParser::MathMLizeTokenContent(mDOMNodeRef node, MathMLTokenElement* parent)
{
  assert(parent != NULL);
...
String*
MathMLParser::SubstituteMCharElement(mDOMNodeRef node)
{
...
MathMLTextNode*
MathMLParser::SubstituteMGlyphElement(mDOMNodeRef node)
{
  assert(node != NULL);
...
MathMLTextNode*
MathMLParser::SubstituteAlignMarkElement(mDOMNodeRef node)
{
  assert(node != NULL);
