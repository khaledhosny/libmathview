...
#define gtk_math_view_get_element_origin   GTKMATHVIEW_METHOD_NAME(get_element_origin)
...
#define gtk_math_view_get_char_origin      GTKMATHVIEW_METHOD_NAME(get_char_origin)
