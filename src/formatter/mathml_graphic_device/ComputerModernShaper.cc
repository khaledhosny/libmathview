...
enum FontMapId { NIL = -1, CMR, CMM, CMS, CME };
...
static VStretchyChar vMap[] = {
    //      N          T          G          M          B
  { 0x0028, CMR, 0x28, CME, 0x30, CME, 0x42, NIL, 0x00, CME, 0x40 },
  { 0x0029, CMR, 0x29, CME, 0x31, CME, 0x43, NIL, 0x00, CME, 0x41 },
  { 0x005B, CMR, 0x5B, CME, 0x32, CME, 0x36, NIL, 0x00, CME, 0x34 },
  { 0x005D, CMR, 0x5D, CME, 0x33, CME, 0x37, NIL, 0x00, CME, 0x35 },
  { 0x007B, CMS, 0x66, CME, 0x38, CME, 0x3E, CME, 0x3C, CME, 0x3A },
  { 0x007D, CMS, 0x67, CME, 0x39, NIL, 0x00, CME, 0x3D, CME, 0x3B },
  { 0x2191, CMS, 0x22, CME, 0x78, CME, 0x3F, NIL, 0x00, NIL, 0x00 },
  { 0x2193, CMS, 0x23, NIL, 0x00, CME, 0x3F, NIL, 0x00, CME, 0x79 },
  { 0x2195, CMS, 0x6C, CME, 0x78, CME, 0x3F, NIL, 0x00, CME, 0x79 },
  { 0x21d1, CMS, 0x2a, CME, 0x7E, CME, 0x77, NIL, 0x00, NIL, 0x00 },
  { 0x21d3, CMS, 0x2b, NIL, 0x00, CME, 0x77, NIL, 0x00, CME, 0x7F },
  { 0x21d5, CMS, 0x6D, CME, 0x7E, CME, 0x77, NIL, 0x00, CME, 0x7F },
  { 0x221A, CMS, 0x70, CME, 0x76, CME, 0x75, NIL, 0x00, CME, 0x74 },
  { 0x2223, CMS, 0x6A, NIL, 0x00, CME, 0x0C, NIL, 0x00, NIL, 0x00 },
  { 0x2225, CMS, 0x6B, NIL, 0x00, CME, 0x0D, NIL, 0x00, NIL, 0x00 },

  { 0x0000, NIL, 0x00, NIL, 0x00, NIL, 0x00, NIL, 0x00, NIL, 0x00 }
};

static BigChar vbMap[] = {
    //      1          2          3          4
  { 0x0028, CME, 0x00, CME, 0x10, CME, 0x12, CME, 0x20 },
  { 0x0029, CME, 0x01, CME, 0x11, CME, 0x13, CME, 0x21 },
  { 0x002F, CME, 0x0E, CME, 0x2E, CME, 0x1E, CME, 0x2C },
  { 0x005B, CME, 0x02, CME, 0x68, CME, 0x14, CME, 0x22 },
  { 0x005D, CME, 0x03, CME, 0x69, CME, 0x15, CME, 0x23 },
  { 0x007B, CME, 0x08, CME, 0x6E, CME, 0x1A, CME, 0x28 },
  { 0x007D, CME, 0x09, CME, 0x6F, CME, 0x1B, CME, 0x29 },
  { 0x220F, CME, 0x51, CME, 0x59, NIL, 0x00, NIL, 0x00 },
  { 0x2210, CME, 0x60, CME, 0x61, NIL, 0x00, NIL, 0x00 },
  { 0x2211, CME, 0x50, CME, 0x58, NIL, 0x00, NIL, 0x00 },
  { 0x2216, CME, 0x0F, CME, 0x2F, CME, 0x1F, CME, 0x2D },
  { 0x221A, CME, 0x70, CME, 0x71, CME, 0x72, CME, 0x73 },
  { 0x2227, CME, 0x56, CME, 0x5E, NIL, 0x00, NIL, 0x00 },
  { 0x2228, CME, 0x57, CME, 0x5F, NIL, 0x00, NIL, 0x00 },
  { 0x222B, CME, 0x52, CME, 0x5A, NIL, 0x00, NIL, 0x00 },
  { 0x222E, CME, 0x48, CME, 0x49, NIL, 0x00, NIL, 0x00 },
  { 0x228E, CME, 0x55, CME, 0x5D, NIL, 0x00, NIL, 0x00 },
  { 0x2294, CME, 0x46, CME, 0x47, NIL, 0x00, NIL, 0x00 },
  { 0x2295, CME, 0x4C, CME, 0x4D, NIL, 0x00, NIL, 0x00 },
  { 0x2297, CME, 0x4E, CME, 0x4F, NIL, 0x00, NIL, 0x00 },
  { 0x2299, CME, 0x4A, CME, 0x4B, NIL, 0x00, NIL, 0x00 },
  { 0x22C2, CME, 0x54, CME, 0x5C, NIL, 0x00, NIL, 0x00 },
  { 0x22C3, CME, 0x53, CME, 0x5B, NIL, 0x00, NIL, 0x00 },
  { 0x2308, CME, 0x06, CME, 0x6C, CME, 0x18, CME, 0x26 },
  { 0x2309, CME, 0x07, CME, 0x6D, CME, 0x19, CME, 0x27 },
  { 0x230A, CME, 0x04, CME, 0x6A, CME, 0x16, CME, 0x24 },
  { 0x230B, CME, 0x05, CME, 0x6B, CME, 0x17, CME, 0x25 },
  { 0x2329, CME, 0x0A, CME, 0x44, CME, 0x1C, CME, 0x2A },
  { 0x232A, CME, 0x0B, CME, 0x45, CME, 0x1D, CME, 0x2B },

  { 0x0000, NIL, 0x00, NIL, 0x00, NIL, 0x00, NIL, 0x00 }
};

static BigChar hbMap[] = {
